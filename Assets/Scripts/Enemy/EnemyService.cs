...
namespace CosmicCuration.Enemy
{
    public class EnemyService
    {
        ...
        public EnemyService(EnemyView enemyPrefab, EnemyScriptableObject enemyScriptableObject)
        {
            ...
            enemyPool = new EnemyPool(enemyPrefab, enemyScriptableObject.enemyData);// we create a new pool at start
            InitializeVariables();
        }
        ...
        {
            EnemyController spawnedEnemy = enemyPool.GetEnemy(); // we now get the enemy from pool
